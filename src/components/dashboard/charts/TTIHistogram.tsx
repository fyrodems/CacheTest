...
const TTIHistogram: React.FC<TTIHistogramProps> = ({ data }) => {
  const bins = getHistogramBins(data, 20);
  if (!data.length) return <div>Brak danych do wyświetlenia histogramu TTI.</div>;
  return (

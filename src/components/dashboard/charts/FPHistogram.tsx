...
const FPHistogram: React.FC<FPHistogramProps> = ({ data }) => {
  const bins = getHistogramBins(data, 20);
  if (!data.length) return <div>Brak danych do wyświetlenia histogramu FP.</div>;
  return (
